...
class LostTheme_Customize {
   ...
   public static function register ( $wp_customize ) {
      ...
      $wp_customize->add_setting( 'link_textcolor', //No need to use a SERIALIZED name, as `theme_mod` settings already live under one db record
         array(
            'default' => '#b45f24', //Default setting/value to save
...
add_action( 'customize_register' , array( 'LostTheme_Customize' , 'register' ) );

// Output custom CSS to live site
add_action( 'wp_head' , array( 'LostTheme_Customize' , 'header_output' ) );

// Enqueue live preview javascript in Theme Customizer admin screen
add_action( 'customize_preview_init' , array( 'LostTheme_Customize' , 'live_preview' ) );
